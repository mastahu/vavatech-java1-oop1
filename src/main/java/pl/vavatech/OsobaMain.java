...
public class OsobaMain {
    ...
    public static void main(String[] args) {
        Osoba tato = new Osoba("Jan", "Kowalski", 35, 150, true, 170);
        Osoba mama = new Osoba("Barbara", "Kowalska", 35, 40, false, 170);
        Osoba corka = new Osoba("Alicja", "Kowalska", 10, 20, false, 170);
        Osoba syn = new Osoba("Stefan", "Kowalski", 10, 120, true, 170);
